          ...
          <tr>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                              <tr>
                                <td align="center">
                                  <a href="https://fundmenaija.com/auth/login" style="color: white;" class="f-fallback button button--blue" target="_blank">Check Account</a>
                                </td>
                              </tr>
                            </table>
                          </td>
              ...
              <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="content-cell" align="center">
                    <p class="f-fallback sub align-center">&copy; <?php echo date("Y"); ?> {APP_NAME}. All rights reserved.</p>
