        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="mailto:contact@FundMeNaija.com" role="button" type="button" class="btn btn-danger">Report an Issue</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row text-muted">
            <div class="col-6 text-left">
                <p class="mb-0">
                    <a href="../../index.php" class="text-muted"><strong><?php echo APP_NAME ?>
                        </strong></a> &copy
                </p>
            </div>
